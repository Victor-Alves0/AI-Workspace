        ...
        if want("google.gmail.mailbox"):
            @sift.tool(
                ...
                params={
                    ...
                    "max_results": "number:o::search: max messages; 0 = ALL matching the query (capped for safety). Omit for the default",
                    "confirm": "boolean:o::set true only after the user confirmed a write (archive/trash/mark)",
                    "account": _ACCOUNT_PARAM,
                },
                returns=["messages", "count", "from", "subject", "date", "snippet", "body", "id", "ok", "action", "error",
